...
const mapStateToProps = (state) => ({
  ...
  sectionsPageInfo: state.merankabandi.sectionsPageInfo,
  fetchingSections: state.merankabandi.fetchingSections,
  errorSections: state.merankabandi.errorSections,
  sectionsTotalCount: state.merankabandi.sectionsTotalCount,
