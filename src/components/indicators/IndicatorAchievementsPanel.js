...
class IndicatorAchievementsPanel extends React.Component {
  ...
  handleDelete = (achievement) => {
    ...
    coreConfirm(
      formatMessage(intl, 'merankabandi', 'indicatorAchievement.delete.confirm.title'),
      formatMessageWithValues(
        intl,
        'merankabandi',
  ...
  confirmDelete = () => {
    ...
    deleteIndicatorAchievement(
      toDelete,
      formatMessage(intl, 'merankabandi', 'indicatorAchievement.delete.mutationLabel'),
    );
    clearConfirm();
  };
  ...
  headers = () => {
    ...
    return [
      {
        id: 'date',
        label: formatMessage(intl, 'merankabandi', 'indicatorAchievement.date'),
        sortable: true,
      },
      {
        id: 'achieved',
        label: formatMessage(intl, 'merankabandi', 'indicatorAchievement.achieved'),
        sortable: true,
      },
      {
        id: 'comment',
        label: formatMessage(intl, 'merankabandi', 'indicatorAchievement.comment'),
        sortable: false,
      },
      {
        id: 'actions',
        label: formatMessage(intl, 'merankabandi', 'indicators.actions'),
        sortable: false,
      },
    ];
  };
        ...
        <Grid container>
          <Grid item xs={12} className={classes.paperHeader}>
            <Typography variant="h6" className={classes.tableTitle}>
              {formatMessage(intl, 'merankabandi', 'indicatorAchievementsPanel.title')}
            </Typography>
            <Button
              variant="contained"
              color="primary"
            ...
            >
              {formatMessage(intl, 'merankabandi', 'indicatorAchievement.add')}
            </Button>
          </Grid>
          <Grid item xs={12}>
            <Divider />
          ...
          <Grid item xs={12}>
            <Searcher
              ...
              tableTitle={formatMessage(intl, 'merankabandi', 'indicatorAchievementsPanel.searcher.title')}
...
const mapStateToProps = (state) => ({
  ...
  indicatorAchievements: state.merankabandi.indicatorAchievements,
  fetchingIndicatorAchievements: state.merankabandi.fetchingIndicatorAchievements,
});
