    ...
    <>
      ...
      {activeFilterCount > 0 && !open && (
        <Paper className={classes.filterChips} elevation={0}>
          ...
          {activeFilterCount > 1 && (
            <Chip
              label={<FormattedMessage id="merankabandi.filter.clearAll" />}
              icon={<Clear />}
      ...
      >
        <div className={classes.drawerHeader}>
          <Typography variant="h6" style={{ flex: 1 }}>
            <FormattedMessage id="merankabandi.filter.title" />
          </Typography>
          {activeFilterCount > 0 && (
        ...
        <div className={classes.filterContent}>
                  ...
                  <Grid item xs={12}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          label={<FormattedMessage id="merankabandi.filter.provinces" />}
                          variant="outlined"
                          size="small"
                          InputProps={{
                            ...params.InputProps,
                    ...
                    <Grid item xs={12}>
                      <Autocomplete
                        ...
                        renderInput={(params) => (
                          <TextField
                            {...params}
                            label={<FormattedMessage id="merankabandi.filter.communes" />}
                            variant="outlined"
                            size="small"
                            InputProps={{
                              ...params.InputProps,
                    ...
                    <Grid item xs={12}>
                      <Autocomplete
                        ...
                        renderInput={(params) => (
                          <TextField
                            {...params}
                            label={<FormattedMessage id="merankabandi.filter.collines" />}
                            variant="outlined"
                            size="small"
                            InputProps={{
                              ...params.InputProps,
          ...
          {filterTypes.includes('benefitPlan') && (
            ...
            >
              ...
              >
                ...
                <Typography>
                  <FormattedMessage id="merankabandi.filter.benefitPlans" />
                </Typography>
                {filters.benefitPlan && (
                  <Box className={classes.filterCount}>
                    1
                  ...
                  <Grid item xs={12}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          label={<FormattedMessage id="merankabandi.filter.selectBenefitPlan" />}
                          variant="outlined"
                          size="small"
                        />
                      )}
          ...
          {(filterTypes.includes('year') || filterTypes.includes('dateRange')) && (
            ...
            >
              ...
              >
                ...
                <Typography>
                  <FormattedMessage id="merankabandi.filter.temporal" />
                </Typography>
              </AccordionSummary>
              <AccordionDetails className={classes.accordionDetails}>
                {filterTypes.includes('year') && (
                  <div className={classes.yearSlider}>
                    <Typography gutterBottom>
                      <FormattedMessage id="merankabandi.filter.year" />
                      :
                      {filters.year}
                    </Typography>
                    <Slider
                ...
                {filterTypes.includes('dateRange') && (
                  <div className={classes.dateContainer}>
                    <PublishedComponent
                      ...
                      label={formatMessage(intl, 'merankabandi', 'filter.startDate')}
                      value={filters.dateRange?.start || null}
                      onChange={(date) => handleFilterChange('dateRange', { ...(filters.dateRange || {}), start: date })}
                    />
                    <PublishedComponent
                      pubRef="core.DatePicker"
                      label={formatMessage(intl, 'merankabandi', 'filter.endDate')}
          ...
          <Box display="flex" gap={2} marginTop={3}>
            ...
            >
              <FormattedMessage id="merankabandi.filter.clear" />
            </Button>
            <Button
              variant="contained"
              color="primary"
            ...
            >
              <FormattedMessage id="merankabandi.filter.apply" />
            </Button>
          </Box>
        </div>
      </Drawer>
