...
function MonetaryTransferSearcher({
  ...
  const openMonetaryTransfer = (monetaryTransfer) => rights.includes(RIGHT_MONETARY_TRANSFER_SEARCH) && history.push(
    `/${modulesManager.getRef('merankabandi.route.monetaryTransfer')}/${monetaryTransfer?.id}`,
  );
...
const mapStateToProps = (state) => ({
  fetchingMonetaryTransfers: state.merankabandi.fetchingMonetaryTransfers,
  fetchedMonetaryTransfers: state.merankabandi.fetchedMonetaryTransfers,
  errorMonetaryTransfers: state.merankabandi.errorMonetaryTransfers,
  monetaryTransfers: state.merankabandi.monetaryTransfers,
  pageInfo: state.merankabandi.monetaryTransfersPageInfo,
  totalCount: state.merankabandi.monetaryTransfersTotalCount,
