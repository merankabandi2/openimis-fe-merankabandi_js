...
const mapStateToProps = (state) => ({
  ...
  fetchingSections: state.merankabandi?.fetchingSections || false,
  fetchingIndicators: state.merankabandi?.fetchingIndicators || false,
  fetchingIndicatorAchievements: state.merankabandi?.fetchingIndicatorAchievements || false,
});
