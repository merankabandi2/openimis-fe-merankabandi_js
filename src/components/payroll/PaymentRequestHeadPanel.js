...
class PaymentRequestHeadPanel extends FormPanel {
  constructor(props) {
    super(props);
    this.state = {
...
export default withModulesManager(injectIntl(withTheme(withStyles(styles)(PaymentRequestHeadPanel))));
