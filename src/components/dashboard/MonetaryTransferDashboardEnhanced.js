...
function MonetaryTransferDashboardEnhanced({ rights, locations }) {
  ...
  const filterConfig = {
    ...
    benefitPlans: {
      ...
      renderComponent: (value, onChange) => (
        <PublishedComponent
          pubRef="merankabandi.BenefitPlanPicker"
          value={value}
          onChange={onChange}
          multiple
          readOnly={false}
  ...
  return (
    <BaseDashboard
      title={<FormattedMessage id="merankabandi.monetaryTransfer.dashboardTitle" />}
      subtitle={<FormattedMessage id="merankabandi.monetaryTransfer.dashboardSubtitle" />}
      module={MODULE_NAME}
      loading={loading}
      error={error}
      onRefresh={refresh}
