...
function MerankabaniBenefitPlanFilter({
              ...
              onChange={(event) => onChangeFilters([
                {
                  ...
                  filter: `isDeleted: ${event.target.checked}`,
                },
              ])}
            />
          )}
...
export default injectIntl(withTheme(withStyles(styles)(MerankabaniBenefitPlanFilter)));
