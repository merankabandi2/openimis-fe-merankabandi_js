...
const mapStateToProps = (state) => ({
  addingProvincePaymentPoint: state.merankabandi.addingProvincePaymentPoint,
  addedProvincePaymentPoint: state.merankabandi.addedProvincePaymentPoint,
  errorProvincePaymentPoint: state.merankabandi.errorProvincePaymentPoint,
});
